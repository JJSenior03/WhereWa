...
class Card33UserGridWidget extends StatefulWidget {
  ...
  @override
  _Card33UserGridWidgetState createState() => _Card33UserGridWidgetState();
}
        ...
        child: Padding(
          ...
          child: Stack(
            ...
            children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          ClipRRect(
                            ...
                            child: Image.network(
                              widget.locatedocwid!.userProfile!,
                              width: 60.0,
                              height: 60.0,
                              fit: BoxFit.cover,
                            ),
              ...
              if (widget.locatedocwid!.userName == currentUserDisplayName)
                Align(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        await widget.locatedocwid!.reference.delete();
