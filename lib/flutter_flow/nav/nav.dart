        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              ...
              asyncParams: {
                'locatedoc':
                    getDoc(['users', 'locate'], LocateRecord.serializer),
                'userdoc': getDoc(['users'], UsersRecord.serializer),
              },
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'HomePage')
                  : HomePageWidget(
                      locatedoc:
                          params.getParam('locatedoc', ParamType.Document),
                      userdoc: params.getParam('userdoc', ParamType.Document),
                      locateref: params.getParam(
                          'locateref',
